...
class AudioTranscriber:
            ...
            while self.transcribing:
                try:
                    ...
                    for segment in segments:
                        ...
                        translated_text = self.translate_text(segment.text, target_lang='hi')
    ...
    def translate_text(self, text, target_lang='hi'):
        try:
            ...
            eel.on_recive_message(f"Translation error: {str(e)}")
    ...
    async def batch_transcribe_audio(self, audio_data: np.ndarray):
        segment_list = []
